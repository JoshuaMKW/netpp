...
public:
    static IApplicationLayerAdapter* create(EApplicationLayerProtocol protocol, ETransportLayerProtocol transport);
    static IApplicationLayerAdapter* detect(const char* data, uint32_t size, ETransportLayerProtocol transport, ISecurityFactory* security);
};
